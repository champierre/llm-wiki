...
- [[overview|石原淳也 — 概要]] — 人物の全体像、経歴、活動領域

## エンティティ（人物・組織・プロジェクト）

### プロジェクト
- [[entities/ml2scratch|ML2Scratch]] — 機械学習 × Scratch拡張機能（★120）
...
- [[entities/tukumana-lab|青学つくまなラボ]] — 青山学院大学メイカースペース（大学教育の軸）
- [[entities/machiquest|まちクエスト]] — 株式会社まちクエスト / 位置情報サービス

## コンセプト

- [[concepts/programming-education|プログラミング教育]] — CoderDojo・つくまなラボ・Scratch・執筆を通じた教育活動の全体像
- [[concepts/generative-ai|生成AIとコーディング]] — LLM活用の実践と考察
